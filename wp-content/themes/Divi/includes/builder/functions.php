...
function et_pb_current_user_can_lock() {
	...
	// TODO: Add new custom WP capability for locking/unlocking content
	$permission = current_user_can( 'edit_private_posts' );
...
function et_pb_add_builder_page_js_css(){
	...
	wp_localize_script( 'et_pb_admin_js', 'et_pb_options', array(
		...
		'ajaxurl'                                  => admin_url( 'admin-ajax.php' ),
		'home_url'                                 => home_url(),
		'preview_url'                              => home_url( '?et_pb_preview=true', $preview_scheme ),
		'et_load_nonce'                            => wp_create_nonce( 'et_load_nonce' ),
