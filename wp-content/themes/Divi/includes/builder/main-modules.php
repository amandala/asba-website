...
class ET_Builder_Module_Blurb extends ET_Builder_Module {
	...
	function shortcode_callback( $atts, $content = null, $function_name ) {
		...
		$image = filter_var( $image, FILTER_VALIDATE_URL ); // make sure valid URL stored in the $image variable
...
class ET_Builder_Module_Code extends ET_Builder_Module {
	...
	function shortcode_callback( $atts, $content = null, $function_name ) {
		...
		$this->shortcode_content = ET_Builder_Element::convert_smart_quotes_and_amp( $this->shortcode_content );

		$this->shortcode_content = htmlspecialchars_decode( $this->shortcode_content );
...
class ET_Builder_Module_Fullwidth_Code extends ET_Builder_Module {
	...
	function shortcode_callback( $atts, $content = null, $function_name ) {
		...
		$this->shortcode_content = et_builder_replace_code_content_entities( $this->shortcode_content );
		$this->shortcode_content = ET_Builder_Element::convert_smart_quotes_and_amp( $this->shortcode_content );
		$this->shortcode_content = html_entity_decode( $this->shortcode_content );
