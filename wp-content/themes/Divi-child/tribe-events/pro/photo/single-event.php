...
<?php echo tribe_event_featured_image( null); ?>
 ...
 <div class="tribe-events-event-details tribe-clearfix">
	...
	<h2 class="tribe-events-list-event-title entry-title summary">
	 ...
	 <?php do_action( 'tribe_events_after_the_meta' ); ?>
		<?php if(tribe_get_formatted_cost() === 'Free'){
			echo "<img class='free-flag upcoming-view' src='../wp-content/themes/Divi-child/images/FreeFlag.png' width='50px;'> <span id='after-free-flag'>to attend</span>";
		}
		else{

			echo "<h4 id='asba-event-cost'>".tribe_get_formatted_cost()."</h4>";
		}
